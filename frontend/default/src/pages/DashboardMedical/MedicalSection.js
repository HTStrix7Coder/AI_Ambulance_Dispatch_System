                ...
                <Col xs={12}>
                    <div className="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div className="flex-grow-1">
                            <h4 className="fs-16 mb-1">Welcome to the AI Medical System!</h4>
                            ...
                            <form action="#">
                                <Row className="g-3 mb-0 align-items-center">
                                    ...
                                    <div className="col-auto">
                                        <button type="button" className="btn btn-soft-success"><i className="ri-add-circle-line align-middle me-1"></i> New Case</button>
                                    </div>
                                    <div className="col-auto">
